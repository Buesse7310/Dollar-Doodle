...
CREATE TABLE Users (
    ...
    User_Pswrd VARCHAR(255) NULL,       -- DO NOT CHANGE THIS LINE -- allow NULL passwords to be compatible with google accounts, NULL passwords are prevented for regular users due to a server side check
